...
function FormComponent() {
  ...
  const categories = ['All', 'Food', 'Transportation', 'Housing', 'Utilities', 'Entertainment'];
  const categoriesNew = ['Select any one...', 'Food', 'Transportation', 'Housing', 'Utilities', 'Entertainment'];

  const handleAddExpense = (e) => {
    e.preventDefault();
    if (!inputExpense || !inputAmount) {
      setErrorMessage('Please enter both expense and amount.');
      return;
    }
    const newExpense = {
